-- Exasol copy of upstream dbt_utils tests/assert_get_query_results_as_dict_objects_equal.sql:
-- Exasol returns uppercase column names, so the dictionary keys are uppercase.
...
{#- Exasol returns uppercase column names -#}
{% if target.type == 'exasol' %}
{% set expected_dictionary={
    'COL_1': [1, 2, 3],
    'COL_2': ['a', 'b', 'c'],
    'COL_3': [True, False, none]
